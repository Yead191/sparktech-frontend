      ...
      <div className="container mx-auto  pb-10  font-sans text-gray-800 antialiased">
        ...
        <div className="flex flex-wrap md:gap-x-16 gap-x-8  gap-y-6  md:my-14 my-8 text-[#414141]">
          ...
          <div className="md:space-y-3 space-y-2">
            ...
            <p className=" font-semibold md:text-xl text-[16px]">
              Onsite – Full time
            </p>
          </div>
          <div className="md:space-y-3 space-y-2">
        ...
        <section className="md:mb-10 mb-6 text-gray-700 leading-relaxed text-justify">
          <h2 className="lg:text-2xl text-xl font-bold text-[#121212] mb-4">
            Job Description
          </h2>
          <p>
            Sparktech is a dynamic and rapidly expanding digital agency,
            committed to driving exceptional results for our clients globally.
            Our success relies heavily on strong, mutually beneficial
            partnerships that expand our reach and service capabilities in key
            international territories. We are seeking a highly motivated and
            relationship-driven
            <strong> Partner Success Executive</strong> to manage, nurture, and
            grow our international network of agency, referral, and technology
            partners.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-4 text-gray-700">
            ...
            <ul className="ml-12 space-y-1 text-gray-600">
              <li>
                • 20 hrs — International Partner research (Through different AI
                tools, LinkedIn or other social media platforms, outreach,
                marketing campaign, international events etc.)
              </li>
              <li>
                • 10 hrs — Partner support (Onboarding communication, training
                coordination, performance tracking, deal closing etc.)
              </li>
              <li>
                • 4 hrs — Cross-functional collaboration (with Pre-sales,
            ...
            <li className="flex gap-4">
              <span className="text-[#0d973d] mt-0.5">•</span>
              <span>
                Identify and approach potential partners in international
                markets through different channels in collaboration with Partner
                Success Manager:
              </span>
            </li>
            <ul className="ml-12 space-y-1 text-gray-600">
            ...
            {[
              ...
              "Provide partners with sales kits, presentations, and case studies to make them confident in representing Sparktech.",
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            <li>
              1-2 years of experience in partner support, business development,
              sales operations, or a related role will be given preference.
              Freshers are also encouraged to apply.
            </li>
            <li>
              Understanding of partner management processes and channel
              strategies.
            </li>
            <li>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            <li>
              Bachelor’s degree in Business, Engineering, Marketing, Sales, or
              related field.
            </li>
            <li>
              Certifications or coursework in international business, partner
              management, or sales is a plus.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            ...
            <li>
              Team hangout, participate in sports events (Table Tennis, Foosball
